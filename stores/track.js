    ...
    getters: {
        ...
        filteredTracks(state) {
            ...
            if (state.filters.year) {
                filteredList = filteredList.filter((track) => {
                    return extractYearFromReleaseDate(track?.release_date) === state.filters.year;
                });
            }
    ...
    actions: {
        async loadTracks() {
            ...
            try {
                ...
                await fetch('https://webdev-music-003b5b991590.herokuapp.com/catalog/selection/all')
                await fetch('https://webdev-music-003b5b991590.herokuapp.com/catalog/selection/2')
